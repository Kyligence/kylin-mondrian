    ...
    private ServerInfo getServerInfo() {
        synchronized (SERVER_INFO_LOCK) {
                ...
                : xmlDataSources.dataSources)
            {
                ...
                String user = null;
                String project = null;
                int idxOfDbname = databaseInfo.name.indexOf("_");
                if (idxOfDbname != -1) {
                ...
                if (databaseInfo.unavailableCatalogList.size() > 0) {
                    ...
                    infoBuff.append("there are ").append(databaseInfo.catalogMap.size()).append(" success dataset, and ").
                            append(databaseInfo.unavailableCatalogList.size()).append(" failed dataset in project ").append(project).append(".");
