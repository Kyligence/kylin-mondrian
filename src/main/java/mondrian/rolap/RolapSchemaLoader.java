...
public class RolapSchemaLoader {
        ...
        MondrianDef.Schema xmlSchema)
    {
        ...
        for (MondrianDef.MeasureGroup xmlMeasureGroup : xmlMeasureGroups) {
            ...
            if (xmlMeasureGroup.isM2M != null && xmlMeasureGroup.PK != null) {
                measureGroup.setManytoManyModel(xmlMeasureGroup.isM2M, xmlMeasureGroup.PK);
            }
        }
...
//        }
        ...
        for (RolapMeasureGroup measureGroup : cube.getMeasureGroups()) {
            ...
            Pair<Boolean, String> pair = measureGroup.getManyToManyModel();
            star.initManyToManyModel(pair.left, pair.right);
