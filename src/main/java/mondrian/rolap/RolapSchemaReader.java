        ...
        NameResolver.Namespace
{
        ...
        Member _parent, Id.Segment childName, MatchType matchType)
    {
        ...
        try {
            ...
            if (context != null && parent.getParentMember() == null && (!parent.getUniqueName().contains("Hierarchy")
                ...
                RolapMemberBase member = new RolapMemberBase(parentMember, childLevel, nameValue,
