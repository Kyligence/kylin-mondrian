...
*/
    ...
    interface LevelReader {
        ...
        boolean constrainRequest(
                RolapMember member,
                RolapMeasureGroup measureGroup,
                CellRequest request, boolean enableExcludeDims);
    ...
    static final class RegularLevelReader implements LevelReader {
                ...
                CellRequest request, boolean enableExcludeDims)
        {
            ...
            if (enableExcludeDims && isExcluded(measureGroup, request)) {
                request.hasExcludedDims = true;
                return false;
            }
        ...
        private boolean isExcluded(RolapMeasureGroup measureGroup, CellRequest request) {
                ...
                CellRequest request, boolean enableExcludeDims)
        {
            ...
            if (member.getDataMember() == null) {
                ...
                return closedPeerLevel.getLevelReader().constrainRequest(
                    wrappedMember, measureGroup, request, enableExcludeDims);
            }
        }
