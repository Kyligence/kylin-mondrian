...
public class Util extends XOMUtil {
    ...
    /**
     * Calender instance use jdbc timezone
     */
    public static final Calendar CalenderWithJdbcTimeZone = Calendar.getInstance
            (TimeZone.getTimeZone(MondrianProperties.instance().JDBCTimeZone.get()));
